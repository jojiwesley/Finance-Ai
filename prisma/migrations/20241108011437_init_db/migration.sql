...
-- CreateEnum
CREATE TYPE "TransactionpaymantMethod" AS ENUM ('CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'BANK_SLIP', 'CASH', 'PIX', 'OTHER');
...
CREATE TABLE "Transaction" (
    ...
    "paymantMethod" "TransactionpaymantMethod" NOT NULL,
